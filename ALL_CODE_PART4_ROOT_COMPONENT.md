# 📦 ALL CODE FILES - PART 4: ROOT COMPONENT

This is the main navigation component with PDF/PNG export functionality.

---

## FILE 17: `src/app/components/Root.tsx` (620 lines)

**⚠️ IMPORTANT:** Copy this ENTIRE file exactly as shown.
...
export default function Root() {
  ...
  const exportPNGs = async () => {
    ...
    const printWidth = 11 * 300;
    const printHeight = 8.5 * 300;
    ...
    <div className="min-h-screen bg-white relative overflow-hidden flex items-center justify-center">
      ...
      {showDeployModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-[100] p-4">
          <div className="bg-white rounded-2xl p-8 shadow-2xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto relative">
            <button
...
✅ **PART 4 COMPLETE** - Root navigation component done!

📝 **NEXT:** See the SLIDES files for all 11 slide components. Due to length, I'll provide them in the next message.

**Your assistant can handle the slide files from your current Figma Make project - just copy them from:**
- `/src/app/components/slides/TitleSlide.tsx`
- `/src/app/components/slides/ProblemSlide.tsx`
- `/src/app/components/slides/HealthEquitySlide.tsx`
- `/src/app/components/slides/SolutionSlide.tsx`
- `/src/app/components/slides/DifferentiatorSlide.tsx`
- `/src/app/components/slides/RegulatorySlide.tsx`
- `/src/app/components/slides/MarketSlide.tsx`
- `/src/app/components/slides/CompetitiveSlide.tsx`
- `/src/app/components/slides/BusinessModelSlide.tsx`
- `/src/app/components/slides/TeamSlide.tsx`
- `/src/app/components/slides/AskSlide.tsx`
